export const LUAT_DAU_THAU_TEXT5 = `### Điều 44. Nội dung hồ sơ mời thầu đối với lựa chọn nhà thầu105
...
3. Hệ thống mạng đấu thầu quốc gia hoạt động liên tục, thống nhất, ổn định,110 có khả năng xác thực người dùng, bảo mật và toàn vẹn dữ liệu.
...
1. Bảo đảm an ninh mạng, bảo mật cơ sở dữ liệu của Hệ thống mạng đấu thầu quốc gia.
...
5. Quản trị rủi ro an ninh mạng của Hệ thống mạng đấu thầu quốc gia.
...
# Chương V MUA SẮM TẬP TRUNG; MUA THUỐC, HÓA CHẤT, VẬT TƯ XÉT NGHIỆM, THIẾT BỊ Y TẾ; CUNG CẤP SẢN PHẨM, DỊCH VỤ CÔNG
...
4. Mua sắm tập trung được thực hiện ở cấp quốc gia, Bộ, cơ quan trung ương, địa phương và thực hiện theo một trong hai cách thức sau đây:
...
Nhà thầu cung cấp cho chủ đầu tư hoá chất, vật tư xét nghiệm, thiết bị y tế, linh kiện, phụ kiện thay thế và các dịch vụ liên quan để vận hành thiết bị y tế theo số lượng dịch vụ kỹ thuật mà chủ đầu tư118 yêu cầu trong hồ sơ mời thầu, hồ sơ yêu cầu, không cung cấp nhân công vận hành thiết bị y tế.
...
a) Phương pháp giá thấp nhất được áp dụng đối với các gói thầu tư vấn đơn giản, gói thầu tư vấn có quy trình thực hiện rõ ràng theo các tiêu chuẩn có sẵn;
